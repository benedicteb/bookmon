...
- The `--series` flag is silently ignored in interactive mode (`-i`). Consider either warning the user or applying the filter to the interactive book selection list.
